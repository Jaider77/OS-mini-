...
def abrir_info_sistema(ventana_padre):
    ...
    def recopilar_informacion():
        ...
        info_str += f"🏗️ Arquitectura: {platform.machine()}\n"
        ...
        try:
            ...
            info_str += f"⚠️ No se pudo obtener información del CPU: {e}\n"
        ...
        try:
            ...
            info_str += f"⚠️ No se pudo obtener información de memoria: {e}\n"
        ...
        try:
            ...
            for particion in particiones:
                try:
                    ...
                    info_str += f"💿 Partición: {particion.device}\n"
                    info_str += f"   ⚠️ Permiso denegado\n\n"
                except Exception:
                    continue
                    
        except Exception as e:
            info_str += f"⚠️ No se pudo obtener información del disco: {e}\n"
        ...
        try:
            ...
            info_str += f"⚠️ No se pudo obtener información de red: {e}\n"
